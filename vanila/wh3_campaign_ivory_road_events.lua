---@diagnostic disable: undefined-field, missing-parameter, param-type-mismatch, need-check-nil, redundant-parameter
...
local event_table = {
  ...
  { function(world_conditions)
    ...
    function(event_conditions, caravan_handle)
      ...
      -- else just ambush
      if caravan:caravan_master():character_details():has_skill("wh3_main_skill_cth_caravan_master_scouts") or
          cm:random_number(3, 0) == 3 then
        local enemy_cqi = attach_battle_to_dilemma(
          dilemma_name,
          caravan,
          attacking_force,
  ...
  { 
    ...
    function(event_conditions, caravan_handle)
      ...
      local ranged_list = { "wh3_main_cth_inf_jade_warrior_crossbowmen_0", "wh3_main_cth_inf_jade_warrior_crossbowmen_1",
        "wh3_main_cth_inf_peasant_archers_0", "wh3_main_ksl_inf_streltsi_0" };
      local melee_list = { "wh3_main_cth_inf_jade_warriors_0", "wh3_main_cth_inf_jade_warriors_1",
        "wh3_main_cth_inf_peasant_spearmen_1" };
  ...
  { 
    ...
    function(event_conditions, caravan_handle)
      ...
      local ranged_list = { "wh3_main_cth_inf_jade_warrior_crossbowmen_0", "wh3_main_cth_inf_jade_warrior_crossbowmen_1",
        "wh3_main_cth_inf_peasant_archers_0" };
      local melee_list = { "wh3_main_cth_inf_jade_warriors_0", "wh3_main_cth_inf_jade_warriors_1",
        "wh3_main_cth_inf_peasant_spearmen_1", "wh3_main_ogr_inf_ogres_0" };
  ...
  --returns its probability [1]
  {
    ...
    function(event_conditions, caravan_handle)
      ...
      local enemy_faction = "wh3_main_sc_kho_khorne_qb1";
      local target_region = decoded_args[1];
      local custom_option = nil;
...
core:add_listener(
  ...
  function(context)
    ...
    if not caravan_system:is_null_interface() then
      ...
      return not active_caravans:is_empty() and
          character:command_queue_index() ==
          active_caravans:item_at(0):caravan_master():character():command_queue_index()
    end
  end,
  function(context)
    out.design("Move caravan from the generic listener")
    cm:move_caravan(cm:model():world():caravans_system():faction_caravans(context:character():faction()):active_caravans()
      :item_at(0))
...
function attach_battle_to_dilemma(
  ...
  if attacking_force ~= nil then
    ...
    enemy_force_cqi, x, y = spawn_caravan_battle_force(caravan, attacking_force, target_region, is_ambush, false,
      enemy_faction)
  end
...
function generate_character()
  ...
  --Pick a trait traits
  local traits = { "wh3_main_trait_dummy_caravan_ex_bandit", "wh3_main_trait_dummy_caravan_con_artist",
    "wh3_main_trait_dummy_caravan_soldier" };
...
function initalise_end_node_values()
  ...
  if cm:get_campaign_name() == "main_warhammer" then
    end_nodes = {
      ...
      ["wh3_main_combi_region_talabheim"]             = 75 - cm:random_number(50, 0),
...
core:add_listener(
  ...
  function(context)
    ...
    return (old_owner:is_human() and old_owner:subculture() == "wh3_main_sc_cth_cathay") or
        (new_owner:is_human() and new_owner:subculture() == "wh3_main_sc_cth_cathay")
  end,
  ---comment
