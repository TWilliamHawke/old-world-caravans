...
function Old_world_caravans:magic_item_creator(context)
  ...
  local skill_to = self:caravan_master_has_cultural_trait(caravan_master, culture_to)
  local skill_from = self:caravan_master_has_cultural_trait(caravan_master, culture_from)
